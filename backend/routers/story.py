...
def build_complete_story_tree(db: Session, story:Story) -> CompleteStoryResponse: #TODO add the type again that i deleted
    ...
    for node in nodes:
        node_response = CompleteStoryNodeResponse(
            ...
            options=node.options #Not sure why it flags this, check later
        )
